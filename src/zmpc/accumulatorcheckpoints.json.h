...
#ifndef MicroPaymentCoin_ACCUMULATORCHECKPOINTS_JSON_H
#define MicroPaymentCoin_ACCUMULATORCHECKPOINTS_JSON_H
...
#endif //MicroPaymentCoin_ACCUMULATORCHECKPOINTS_JSON_H
